...
Input "This is Automation Testing JavaPracticeJan26_31.NegativePositiveNumber.Interview"
Output "Th*s *s **t*m*t**n T*st*ng *nt*rv**w"

 */
public class RemoveVowels {
    public static void main(String[] args) {
        String str = "This is Automation Testing JavaPracticeJan26_31.NegativePositiveNumber.Interview";
